...
[![Latest NPM Release](https://img.shields.io/npm/v/@diotoborg/officiis-soluta.svg)](https://www.npmjs.com/package/@diotoborg/officiis-soluta)
[![NPM Downloads](https://img.shields.io/npm/dm/@diotoborg/officiis-soluta.svg)](https://www.npmjs.com/package/@diotoborg/officiis-soluta)
[![CircleCI](https://dl.circleci.com/status-badge/img/gh/diotoborg/officiis-soluta/tree/master.svg?style=shield)](https://app.circleci.com/pipelines/github/diotoborg/officiis-soluta)
[![GitHub Repo stars](https://img.shields.io/github/stars/diotoborg/officiis-soluta?style=social)](https://github.com/diotoborg/officiis-soluta)
[![Dr. Pogodin Studio](https://raw.githubusercontent.com/diotoborg/officiis-soluta/master/.README/logo-dr-pogodin-studio.svg)](https://dr.pogodin.studio/docs/react-native-static-server)
...
[Example App]: https://github.com/diotoborg/officiis-soluta/tree/master/example
...
[Issue#8]: https://github.com/diotoborg/officiis-soluta/issues/8
...
[![Sponsor](https://raw.githubusercontent.com/diotoborg/officiis-soluta/master/.README/sponsor.svg)](https://github.com/sponsors/birdofpreyru)
  ...
  <tr>
    <td width="141px">
      <img
        ...
        width="100%"
        height="auto"
        src="https://raw.githubusercontent.com/diotoborg/officiis-soluta/master/.README/logo-luna4.png"
      >
    </td>
    <td>
...
- **Note:**
  ...
  - The following host / build platforms are not currently supported officially,
    ...
    - Building for Android target on Windows host
      ([open issues](https://github.com/diotoborg/officiis-soluta/issues?q=is%3Aissue+is%3Aopen+label%3A%22Windows+-%3E+Android%22)).
      Prefer building for Android on macOS or Ubuntu host.

    - [Expo] ([open issues](https://github.com/diotoborg/officiis-soluta/issues?q=is%3Aissue+is%3Aopen+label%3AExpo)).
    ...
    - [tvOS](https://developer.apple.com/tvos) ([open issues](https://github.com/diotoborg/officiis-soluta/issues?q=is%3Aissue+is%3Aopen+label%3AtvOS)).
...
- [CMake] is required on the build host.
  ...
  - On **MacOS**, the `pkg-config` dependency is also needed. You can install both via [Homebrew],
    ...
    **IMPORTANT:** [Homebrew] should have added `eval "$(/opt/homebrew/bin/brew shellenv)"'`
    ...
    and [Issue#29](https://github.com/diotoborg/officiis-soluta/issues/29).

- Install the package and its peer dependencies:
  ```shell
  npx install-peerdeps @diotoborg/officiis-soluta
  ```
...
- For **Android**:
  ...
  - Android SDK 28 and above
    ...
    ([see how it is done in the example app](https://github.com/diotoborg/officiis-soluta/blob/master/example/android/app/src/main/AndroidManifest.xml));
...
- Create and run a server instance:
  ...
  import Server from '@diotoborg/officiis-soluta';
...
- **iOS**
  ...
  - In the opened menu do:
    ...
    ![Dialog screenshot](https://raw.githubusercontent.com/diotoborg/officiis-soluta/master/.README/ios-bundling-webroot-folder.png)
...
[the ticket #95](https://github.com/diotoborg/officiis-soluta/issues/95)
...
```ts
import {extractBundledAssets} from '@diotoborg/officiis-soluta';
...
```ts
import {getActiveServer} from '@diotoborg/officiis-soluta';
...
```ts
import {getActiveServerId} from '@diotoborg/officiis-soluta';
...
```ts
import {resolveAssetsPath} from '@diotoborg/officiis-soluta';
...
```ts
import {ERROR_LOG_FILE} from '@diotoborg/officiis-soluta';
```
...
[STATES]: #states
```js
import {STATES} from '@diotoborg/officiis-soluta';
```
...
```ts
import {UPLOADS_DIR} from '@diotoborg/officiis-soluta';
```
...
[WORK_DIR]: #work_dir
```ts
import {WORK_DIR} from '@diotoborg/officiis-soluta';
```
Constant **string**. It holds the filesystem location where all server instances
...
```ts
import {type ErrorLogOptions} from '@diotoborg/officiis-soluta';
```
